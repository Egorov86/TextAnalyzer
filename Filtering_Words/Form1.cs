...
namespace WinFormsApp3
{
    public partial class Form1 : Form
    {
        ...
        private void btnLoadForbiddenWords_Click(object sender, EventArgs e)
        {
            using (var openFileDialog = new OpenFileDialog())
            {
                ...
                if (openFileDialog.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show("ñëîâà çàãðóæåíû");
                }
            }
        }
        ...
        private void ProcessFiles(CancellationToken token)
        {
            ...
            MessageBox.Show("Îáðàáîòêà çàâåðåøíà");
        }
        ...
        private void ProcessFile(string filePath)
        {
            ...
            {
                string originalFilePath = Path.Combine("C:\\Users\\Пользователь\\Documents\\", Path.GetFileName(filePath));
                string modifiedFilePath = Path.Combine("C:\\Users\\Пользователь\\Documents\\", Path.GetFileName(filePath));
        ...
        private void GenerateReport()
        {
            var topWords = forbiddenWords.GroupBy(w => w)
                ...
                .ToList();
            string report = "òîï 10 çàïðåùåííûõ ñëîâ:\n";
